...
public class ProjectClient {
	...
	@HystrixCommand(commandKey = "ProjectClient", fallbackMethod = "getProjectFromCache")
	...
	@HystrixCommand(commandKey = "ProjectClientCache", threadPoolKey = "ProjectClientCache")
